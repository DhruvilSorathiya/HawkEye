...
def start_web_server(heWebUiConfig: dict, heConfig: dict, loggingQueue=None) -> None:
    ...
    conf = {
        '/': {
            ...
            'tools.sessions.timeout': 1440,  # 24 hours
        },
        '/query': {
    ...
    # Disable old authentication system - using new login system instead
    log.info("Using new authentication system. Old passwd file authentication disabled.")
    # else:
    #     warn_msg = "\n********************************************************************\n"
...
if __name__ == '__main__':
    ...
    if len(sys.argv) <= 1:
        print("HawkEye requires -l <ip>:<port> to start the web server. Try --help for guidance.")
        sys.exit(-1)
